...
void render_logo(void) {
    static const char PROGMEM oma_logo[] = {
        0xe0, 0xe1, 0xe2, 0xe3, 0xe4,
        0xe5, 0xe6, 0xe7, 0xe8, 0xe9,
        0xea, 0xeb, 0xec, 0xed, 0xee,
        0xef, 0xf0, 0xf1, 0xf2, 0xf3, 0};
    oled_write_P(oma_logo, false);
}

// Función principal de OLED, puedes agregar más funcionalidades aquí
